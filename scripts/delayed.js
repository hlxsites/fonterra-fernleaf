...
function GoogleTagManager() {
  this.loadGTM = () => {
    ...
    })(window,document,'script','dataLayer','GTM-NX6JQZG');window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}gtag('set', { 'cookie_flags': 'SameSite=None;Secure' });`;
